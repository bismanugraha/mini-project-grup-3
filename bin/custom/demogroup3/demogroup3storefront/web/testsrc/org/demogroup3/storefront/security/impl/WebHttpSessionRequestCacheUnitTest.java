...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup3storefront/electronics/en",
						"https://electronics.local:9002/demogroup3storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup3storefront/electronics/en",
						"https://electronics.local:9002/demogroup3storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogroup3storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/demogroup3storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogroup3storefront/electronics/en",
						"https://electronics.local:9002/demogroup3storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogroup3storefront",
						"https://electronics.local:9002/demogroup3storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogroup3storefront",
						"https://electronics.local:9002/demogroup3storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup3storefront/electronics/en",
						"https://electronics.local:9002/demogroup3storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
