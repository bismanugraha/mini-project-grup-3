 ...
 */
package org.demogroup3.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Demogroup3FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Demogroup3FulfilmentProcessConstants.PARENT_PROCESS);
