 ...
 */
package org.demogroup3.test.setup;
...
import org.demogroup3.test.constants.Demogroup3TestConstants;
import org.demogroup3.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Demogroup3TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/demogroup3test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/demogroup3test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/demogroup3test/import/cstickets.impex");
			...
			importImpexFile(context, "/demogroup3test/import/csquotes.impex");
		}
	}
}
